    ...
    return (
        <div className="max-w-3xl mx-auto">
            <header className="mb-8">
                ...
                <p className="text-gray-500">List a new book for sale in the marketplace</p>
            </header>
                ...
                <div className="p-6 md:p-8 space-y-6">
                            ...
                            {imagePreview ? (
                                ...
                                <div className="space-y-1 text-center">
                                    ...
                                    <div className="flex text-sm text-gray-600 justify-center">
                                        <label htmlFor="file-upload" className="relative cursor-pointer bg-white rounded-md font-medium text-kindle-600 hover:text-kindle-500 focus-within:outline-none">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-7 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-kindle-500 focus:border-kindle-500"
                                    placeholder="0.00"
                                />
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-kindle-500 focus:border-kindle-500"
                            placeholder="Describe the book's details, plot summary, or specific condition notes..."
                        />
                    </div>
                </div>
